    ...
    <section className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-surface-50 to-white dark:from-surface-950 dark:via-surface-900 dark:to-surface-950">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-chrysolite-vivid rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-3000"></div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-chrysolite-500/20 via-gold-400/20 to-chrysolite-500/20 rounded-full blur-3xl animate-glow"></div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-chrysolite-500/10 to-gold-400/10 border border-chrysolite-500/30 rounded-full px-4 py-2 mb-8 animate-fade-in">
            <Sparkles size={16} className="text-chrysolite-400 animate-pulse" />
            <span className="text-sm font-medium text-chrysolite-400">Ready to Transform Your Business?</span>
          </div>
