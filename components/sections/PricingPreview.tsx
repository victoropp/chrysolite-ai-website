    ...
    <section className="relative py-24 lg:py-32 overflow-hidden bg-gradient-to-b from-surface-900 to-surface-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Main Pricing Card */}
          <div className="relative bg-surface-900/50 backdrop-blur-xl border border-surface-800 rounded-3xl overflow-hidden">
            {/* Gradient Background */}
            ...
            <div className="relative grid lg:grid-cols-2 gap-12 p-12">
              ...
              <div className="space-y-6">
                ...
                {/* Trust Badge */}
                <div className="pt-6">
                  <div className="inline-flex items-center gap-2 bg-surface-800/50 border border-surface-700 rounded-full px-4 py-2">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span className="text-sm text-surface-300">No hidden fees • Cancel anytime</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-left space-y-8">
                <div>
                  ...
                  <p className="text-surface-400 text-lg">Pricing based on your requirements</p>
                </div>
                ...
                <div className="w-full max-w-md">
                  ...
                  <div className="flex flex-col gap-3">
                    <Link
                      href="/contact"
                      className="group bg-gradient-to-r from-gold-400 to-gold-500 hover:from-gold-300 hover:to-gold-400 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 shadow-lg shadow-gold-400/40 hover:shadow-gold-400/60 hover:scale-105 flex items-center justify-center gap-2"
                    >
                    ...
                    <Link
                      ...
                      className="group bg-surface-800/50 backdrop-blur-xl hover:bg-surface-800 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 border border-surface-700 hover:border-chrysolite-500/50 flex items-center justify-center gap-2"
                    >
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="text-center p-6 bg-surface-900/30 backdrop-blur-xl border border-surface-800 rounded-xl">
              ...
              <div className="text-sm text-surface-400">Modules & Features</div>
            </div>
            <div className="text-center p-6 bg-surface-900/30 backdrop-blur-xl border border-surface-800 rounded-xl">
              <div className="text-3xl font-bold gradient-text-gold mb-2">24/7</div>
              <div className="text-sm text-surface-400">Customer Support</div>
            </div>
            <div className="text-center p-6 bg-surface-900/30 backdrop-blur-xl border border-surface-800 rounded-xl">
