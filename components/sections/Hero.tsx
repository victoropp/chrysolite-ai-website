  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-surface-900/80 backdrop-blur-xl border border-chrysolite-500/30 rounded-full px-4 py-2 mb-8 animate-fade-in">
          <Sparkles size={16} className="text-chrysolite-vivid" />
          <span className="text-sm text-surface-200">AI-Powered Enterprise Resource Planning</span>
        </div>

        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 animate-fade-in-up animation-delay-100 leading-tight">
          The AI-Powered ERP That{' '}
          <span className="gradient-text">Runs Your Business</span>
        </h1>

        {/* Subheadline */}
        <p className="text-xl sm:text-2xl text-surface-300 max-w-3xl mx-auto mb-12 animate-fade-in-up animation-delay-200">
          Automate accounting, inventory, payroll, CRM, and more with intelligent insights.
          One platform. Infinite possibilities.
        </p>

        {/* Trust Indicators */}
        <div className="flex flex-wrap items-center justify-center gap-8 mb-12 text-surface-400 text-sm animate-fade-in-up animation-delay-300">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-400">
          ...
          <Link
            href="/contact"
            className="group bg-surface-800/50 backdrop-blur-xl hover:bg-surface-800 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 border border-surface-700 hover:border-chrysolite-500/50 flex items-center gap-2"
          >
        ...
        <div className="mt-16 animate-fade-in-up animation-delay-500">
          ...
          <div className="flex items-center justify-center gap-8 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all">
            ...
            <div className="text-surface-600 text-sm">Logo 1</div>
            <div className="text-surface-600 text-sm">Logo 2</div>
            <div className="text-surface-600 text-sm">Logo 3</div>
            <div className="text-surface-600 text-sm">Logo 4</div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-float">
        <div className="w-6 h-10 border-2 border-surface-600 rounded-full flex items-start justify-center p-2">
