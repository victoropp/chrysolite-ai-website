        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className={cn(
                'group relative bg-surface-900/50 backdrop-blur-xl border border-surface-800 rounded-2xl p-6',
                'hover:bg-surface-900/80 hover:border-chrysolite-500/30 transition-all duration-300',
