      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-surface-100 to-surface-200 dark:from-surface-900 dark:to-surface-800 border border-surface-300 dark:border-surface-700 rounded-2xl p-16 text-center shadow-2xl">
            ...
            <div className="text-surface-900 dark:text-white font-semibold mb-6">Meanwhile, connect with us on social media:</div>
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              <a
                ...
                className="w-12 h-12 flex items-center justify-center bg-surface-50 dark:bg-surface-900 border border-surface-300 dark:border-surface-800 rounded-lg text-surface-600 dark:text-surface-400 hover:text-chrysolite-400 hover:border-chrysolite-500/30 transition-all duration-200"
              >
                <Twitter size={20} />
              </a>
              <a
