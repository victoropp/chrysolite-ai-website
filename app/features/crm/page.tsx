          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-700 rounded-2xl p-8 shadow-2xl">
                <h3 className="text-white font-semibold mb-6">Sales Pipeline</h3>
                <div className="space-y-4">
                  <div className="p-4 bg-surface-950/50 rounded-xl">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-surface-400">Stage: Negotiation</span>
                      <span className="text-green-400">80% probability</span>
                    </div>
                  </div>
                  <div className="p-4 bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <span className="text-white font-medium">Tech Solutions Ltd</span>
                      <span className="text-chrysolite-400 font-semibold">$89,500</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-surface-400">Stage: Proposal</span>
                      <span className="text-yellow-400">60% probability</span>
                    </div>
                  </div>
                  <div className="p-4 bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <span className="text-white font-medium">Global Enterprises</span>
                      <span className="text-chrysolite-400 font-semibold">$250,000</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-surface-400">Stage: Discovery</span>
                      <span className="text-blue-400">30% probability</span>
                    </div>
                  </div>
                </div>
                <div className="mt-6 pt-6 border-t border-surface-700 flex justify-between">
                  <span className="text-surface-400">Total Pipeline Value</span>
                  <span className="text-white text-xl font-bold">$464,500</span>
                </div>
              </div>
            </div>
          </div>
