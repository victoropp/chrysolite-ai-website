...
export const metadata: Metadata = {
  title: 'Banking & Cash Management | Chrysolite AI ERP',
  description: 'Complete banking solution with bank reconciliation, transfers, payment processing, cash flow management, and multi-currency support.',
}
...
const features = [
  {
    ...
    description: 'Manage multiple bank accounts across different banks and currencies in one place.',
  },
  {
    icon: RefreshCw,
    title: 'Auto Reconciliation',
    description: 'AI-powered bank statement reconciliation with automated matching and variance detection.',
  },
  {
    icon: ArrowLeftRight,
    title: 'Bank Transfers',
    description: 'Inter-bank transfers with approval workflows and automated journal postings.',
  },
  {
    icon: CreditCard,
    title: 'Payment Processing',
    description: 'Batch payments, direct debits, and integration with payment gateways.',
  },
  {
    icon: Shield,
    title: 'Fraud Detection',
    description: 'AI-powered anomaly detection and duplicate payment prevention.',
  },
  {
    icon: Zap,
    title: 'Cash Flow Forecasting',
    description: 'Predict cash positions with AI-driven forecasting and scenario modeling.',
  },
]
...
const benefits = [
  ...
  'Payment approval workflows with segregation of duties',
  'Cash flow forecasting with AI predictions',
  'Integration with accounting for automated GL postings',
]
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-chrysolite-500 to-gold-400 rounded-2xl mb-8 shadow-lg shadow-chrysolite/30">
              <Landmark size={40} className="text-surface-900 dark:text-white" />
            </div>
            ...
            <p className="text-xl text-surface-600 dark:text-surface-300 mb-12 leading-relaxed">
              Complete control over your cash flow with automated bank reconciliation, payment processing,
              and AI-powered cash forecasting. Never run out of cash again.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-surface-600 dark:text-surface-400 max-w-2xl mx-auto">
              Manage all your banking operations from a single, powerful platform.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-surface-600 dark:text-surface-400 mb-8">
                Automate bank reconciliation, detect anomalies, and forecast cash flow with AI.
                Our intelligent system learns from your transaction patterns.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-surface-100 to-surface-200 dark:from-surface-900 dark:to-surface-800 border border-surface-300 dark:border-surface-700 rounded-2xl p-8 shadow-2xl">
                <h3 className="text-surface-900 dark:text-white font-semibold mb-6">Bank Accounts Overview</h3>
                <div className="space-y-4">
                  <div className="p-4 bg-white dark:bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <div>
                        <div className="text-surface-900 dark:text-white font-medium">Operating Account</div>
                        <div className="text-sm text-surface-600 dark:text-surface-400">Ecobank - GHS</div>
                      </div>
                      <div className="text-right">
                        <div className="text-chrysolite-400 text-lg font-semibold">GH₵ 234,567</div>
                        <div className="text-xs text-green-400">Reconciled</div>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 bg-white dark:bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <div>
                        <div className="text-surface-900 dark:text-white font-medium">USD Account</div>
                        <div className="text-sm text-surface-600 dark:text-surface-400">Stanbic - USD</div>
                      </div>
                      <div className="text-right">
                        <div className="text-chrysolite-400 text-lg font-semibold">$89,450</div>
                        <div className="text-xs text-green-400">Reconciled</div>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 bg-white dark:bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <div>
                        <div className="text-surface-900 dark:text-white font-medium">Payroll Account</div>
                        <div className="text-sm text-surface-600 dark:text-surface-400">GCB Bank - GHS</div>
                      </div>
                      <div className="text-right">
                        <div className="text-chrysolite-400 text-lg font-semibold">GH₵ 125,000</div>
                ...
                <div className="mt-6 pt-6 border-t border-surface-300 dark:border-surface-700 flex justify-between">
                  <span className="text-surface-600 dark:text-surface-400">Total Cash Position</span>
                  <span className="text-surface-900 dark:text-white text-xl font-bold">GH₵ 448,017</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-surface-100/30 dark:bg-surface-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-surface-600 dark:text-surface-400 max-w-2xl mx-auto mb-12">
            Banking integrates with accounting, payroll, and payment modules for
            complete cash flow automation and visibility.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-8">
            {['Accounting', 'Payroll', 'Payments', 'Reporting', 'Forecasting', 'Analytics'].map((module) => (
              <div
                key={module}
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-surface-600 dark:text-surface-400 mb-12">
            Join businesses managing cash with confidence and precision.
          </p>
