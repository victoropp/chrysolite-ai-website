          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-700 rounded-2xl p-8 shadow-2xl">
                <h3 className="text-white font-semibold mb-6">Bank Accounts Overview</h3>
                <div className="space-y-4">
                  <div className="p-4 bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <div>
                        <div className="text-white font-medium">Operating Account</div>
                        <div className="text-sm text-surface-400">Ecobank - GHS</div>
                      </div>
                  ...
                  <div className="p-4 bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <div>
                        <div className="text-white font-medium">USD Account</div>
                        <div className="text-sm text-surface-400">Stanbic - USD</div>
                      </div>
                      <div className="text-right">
                  ...
                  <div className="p-4 bg-surface-950/50 rounded-xl">
                    <div className="flex justify-between mb-2">
                      <div>
                        <div className="text-white font-medium">Payroll Account</div>
                        <div className="text-sm text-surface-400">GCB Bank - GHS</div>
                      </div>
                      <div className="text-right">
                ...
                <div className="mt-6 pt-6 border-t border-surface-700 flex justify-between">
                  <span className="text-surface-400">Total Cash Position</span>
                  <span className="text-white text-xl font-bold">GH₵ 448,017</span>
                </div>
              </div>
            </div>
          </div>
