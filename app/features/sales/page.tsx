          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-700 rounded-2xl p-8 shadow-2xl">
                <h3 className="text-white font-semibold mb-6">AR Aging Summary</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">Current (0-30 days)</span>
                    <span className="text-chrysolite-400 font-semibold">$45,230</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">31-60 days</span>
                    <span className="text-yellow-400 font-semibold">$12,450</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">61-90 days</span>
                    <span className="text-orange-400 font-semibold">$5,670</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">Over 90 days</span>
                    <span className="text-red-400 font-semibold">$2,340</span>
                  </div>
                </div>
                <div className="mt-6 pt-6 border-t border-surface-700 flex items-center justify-between">
                  <span className="text-surface-400">Total Outstanding</span>
                  <span className="text-white text-xl font-bold">$65,690</span>
                </div>
              </div>
            </div>
          </div>
