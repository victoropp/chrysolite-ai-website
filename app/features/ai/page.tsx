                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="bg-white dark:bg-surface-950/50 rounded-2xl rounded-tl-none p-4 flex-1">
                      <p className="text-surface-600 dark:text-surface-300 text-sm">What's my current cash position?</p>
                    </div>
                  </div>
                  <div className="flex gap-3 justify-end">
                    <div className="bg-chrysolite-500/20 border border-chrysolite-500/30 rounded-2xl rounded-tr-none p-4 flex-1">
                      <p className="text-surface-900 dark:text-white text-sm mb-2">Your current cash position is <span className="font-semibold text-chrysolite-400">GH₵ 448,017</span> across 3 bank accounts.</p>
                      <p className="text-surface-600 dark:text-surface-300 text-xs">• Operating: GH₵ 234,567<br />• USD Account: $89,450 (GH₵ 88,450)<br />• Payroll: GH₵ 125,000</p>
                    </div>
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-chrysolite-500 to-gold-400 flex items-center justify-center flex-shrink-0">
                      <Brain size={16} className="text-surface-900 dark:text-white" />
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-8 h-8 rounded-full bg-surface-700 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="bg-white dark:bg-surface-950/50 rounded-2xl rounded-tl-none p-4 flex-1">
                      <p className="text-surface-600 dark:text-surface-300 text-sm">Will I have enough cash next month?</p>
                    </div>
                  </div>
                  <div className="flex gap-3 justify-end">
                    <div className="bg-chrysolite-500/20 border border-chrysolite-500/30 rounded-2xl rounded-tr-none p-4 flex-1">
                      <p className="text-surface-900 dark:text-white text-sm">Based on your payment schedule and forecasted revenue, you'll have <span className="font-semibold text-chrysolite-400">GH₵ 385,000</span> by month-end. However, there's a potential shortfall on Feb 15. I recommend accelerating AR collection.</p>
                    </div>
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-chrysolite-500 to-gold-400 flex items-center justify-center flex-shrink-0">
                      <Brain size={16} className="text-surface-900 dark:text-white" />
                    </div>
