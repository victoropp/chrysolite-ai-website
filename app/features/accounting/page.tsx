              ...
              <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-700 rounded-2xl p-8 shadow-2xl">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">Cash in Bank</span>
                    <span className="text-white font-semibold">$234,567.89</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">Accounts Receivable</span>
                    <span className="text-white font-semibold">$89,234.56</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-surface-950/50 rounded-xl">
                    <span className="text-surface-400">Revenue (MTD)</span>
