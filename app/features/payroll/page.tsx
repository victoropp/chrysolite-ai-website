        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-chrysolite-500 to-gold-400 rounded-2xl mb-8 shadow-lg shadow-chrysolite/30">
              <Users size={40} className="text-surface-900 dark:text-white" />
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-300 dark:border-surface-700 rounded-2xl p-8 shadow-2xl">
                <h3 className="text-surface-900 dark:text-white font-semibold mb-6">Sample Payslip</h3>
                <div className="space-y-3">
                  <div className="flex justify-between p-3 bg-white dark:bg-surface-950/50 rounded-lg">
                    <span className="text-surface-600 dark:text-surface-400">Basic Salary</span>
                    <span className="text-surface-900 dark:text-white font-semibold">GH₵ 5,000.00</span>
                  </div>
                  <div className="flex justify-between p-3 bg-white dark:bg-surface-950/50 rounded-lg">
                    <span className="text-surface-600 dark:text-surface-400">Allowances</span>
                    <span className="text-surface-900 dark:text-white font-semibold">GH₵ 1,500.00</span>
                  </div>
                  <div className="flex justify-between p-3 bg-white dark:bg-surface-950/50 rounded-lg border-t border-surface-300 dark:border-surface-700 pt-3">
                    <span className="text-surface-600 dark:text-surface-400">Gross Pay</span>
                    <span className="text-surface-900 dark:text-white font-semibold">GH₵ 6,500.00</span>
                  </div>
                  <div className="flex justify-between p-3 bg-white dark:bg-surface-950/50 rounded-lg">
                    <span className="text-surface-600 dark:text-surface-400">PAYE</span>
                    <span className="text-red-400 font-semibold">- GH₵ 890.00</span>
                  </div>
                  <div className="flex justify-between p-3 bg-white dark:bg-surface-950/50 rounded-lg">
                    <span className="text-surface-600 dark:text-surface-400">SSNIT (5.5%)</span>
                    <span className="text-red-400 font-semibold">- GH₵ 357.50</span>
                  </div>
                  <div className="flex justify-between p-3 bg-white dark:bg-surface-950/50 rounded-lg">
                    <span className="text-surface-600 dark:text-surface-400">Tier 3 (5%)</span>
                  ...
                  <div className="flex justify-between p-4 bg-chrysolite-500/10 rounded-lg border border-chrysolite-500/30 mt-4">
                    <span className="text-surface-900 dark:text-white font-semibold">Net Pay</span>
