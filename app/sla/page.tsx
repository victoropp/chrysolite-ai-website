      ...
      <section className="relative pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-surface-50/50 dark:bg-surface-900/50 border border-surface-300 dark:border-surface-800 rounded-2xl p-8 md:p-12 space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Uptime Commitment</h2>
              ...
              <div className="bg-white dark:bg-surface-950/50 border border-surface-300 dark:border-surface-800 rounded-xl p-6">
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  <div>
                    <div className="text-3xl font-bold text-chrysolite-400 mb-2">99.9%</div>
                    <p className="text-surface-600 dark:text-surface-400 text-sm">Uptime Guarantee</p>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-chrysolite-400 mb-2">43m</div>
                    <p className="text-surface-600 dark:text-surface-400 text-sm">Max Monthly Downtime</p>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-chrysolite-400 mb-2">24/7</div>
                    <p className="text-surface-600 dark:text-surface-400 text-sm">System Monitoring</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-surface-900 dark:text-white font-medium">Scheduled Maintenance</p>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 size={20} className="text-chrysolite-400 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-surface-900 dark:text-white font-medium">Emergency Maintenance</p>
                    <p className="text-surface-600 dark:text-surface-300 text-sm">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Support Response Times</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-surface-950/50 border border-surface-300 dark:border-surface-800 rounded-xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-surface-900 dark:text-white">Critical Issues</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Starter</p>
                      <p className="text-surface-900 dark:text-white font-medium">4 hours</p>
                    </div>
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Professional</p>
                      <p className="text-surface-900 dark:text-white font-medium">2 hours</p>
                    </div>
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Enterprise</p>
                      <p className="text-surface-900 dark:text-white font-medium">1 hour</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-surface-950/50 border border-surface-300 dark:border-surface-800 rounded-xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-surface-900 dark:text-white">High Priority Issues</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Starter</p>
                      <p className="text-surface-900 dark:text-white font-medium">8 hours</p>
                    </div>
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Professional</p>
                      <p className="text-surface-900 dark:text-white font-medium">4 hours</p>
                ...
                <div className="bg-white dark:bg-surface-950/50 border border-surface-300 dark:border-surface-800 rounded-xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-surface-900 dark:text-white">Normal Priority Issues</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Starter</p>
                      <p className="text-surface-900 dark:text-white font-medium">24 hours</p>
                    </div>
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Professional</p>
                      <p className="text-surface-900 dark:text-white font-medium">12 hours</p>
                    </div>
                    <div>
                      <p className="text-surface-600 dark:text-surface-400 mb-1">Enterprise</p>
                      <p className="text-surface-900 dark:text-white font-medium">4 hours</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Service Credits</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed mb-4">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-surface-300 dark:border-surface-800">
                      <th className="text-left text-surface-900 dark:text-white font-semibold py-3">Monthly Uptime</th>
                      <th className="text-left text-surface-900 dark:text-white font-semibold py-3">Service Credit</th>
                    </tr>
                  </thead>
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Exclusions</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed mb-4">
