        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-chrysolite-500 to-gold-400 rounded-2xl mb-8 shadow-lg shadow-chrysolite/30">
              <Code size={40} className="text-surface-900 dark:text-white" />
            </div>
          ...
          <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-300 dark:border-surface-700 rounded-2xl p-16 text-center shadow-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white dark:bg-surface-950/50 rounded-xl p-6 border border-surface-300 dark:border-surface-800">
                ...
                <h3 className="text-surface-900 dark:text-white font-semibold mb-2">RESTful API</h3>
                <p className="text-surface-600 dark:text-surface-400 text-sm">Clean, predictable endpoints</p>
              </div>
              <div className="bg-white dark:bg-surface-950/50 rounded-xl p-6 border border-surface-300 dark:border-surface-800">
                <Lock size={32} className="text-chrysolite-400 mx-auto mb-4" />
                <h3 className="text-surface-900 dark:text-white font-semibold mb-2">OAuth 2.0</h3>
                <p className="text-surface-600 dark:text-surface-400 text-sm">Secure authentication</p>
              </div>
              <div className="bg-white dark:bg-surface-950/50 rounded-xl p-6 border border-surface-300 dark:border-surface-800">
                <FileCode size={32} className="text-chrysolite-400 mx-auto mb-4" />
                <h3 className="text-surface-900 dark:text-white font-semibold mb-2">Webhooks</h3>
                <p className="text-surface-600 dark:text-surface-400 text-sm">Real-time events</p>
              </div>
            </div>
