        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-chrysolite-500 to-gold-400 rounded-2xl mb-8 shadow-lg shadow-chrysolite/30">
              <Award size={40} className="text-surface-900 dark:text-white" />
            </div>
          ...
          <div className="bg-gradient-to-br from-surface-100 to-surface-200 dark:from-surface-900 dark:to-surface-800 border border-surface-300 dark:border-surface-700 rounded-2xl p-16 text-center shadow-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white dark:bg-surface-950/50 rounded-xl p-6 border border-surface-300 dark:border-surface-800">
                ...
                <p className="text-surface-600 dark:text-surface-400 text-sm">Happy Customers</p>
              </div>
              <div className="bg-white dark:bg-surface-950/50 rounded-xl p-6 border border-surface-300 dark:border-surface-800">
                <div className="text-4xl font-bold text-chrysolite-400 mb-2">80%</div>
                <p className="text-surface-600 dark:text-surface-400 text-sm">Time Saved on Manual Tasks</p>
              </div>
              <div className="bg-white dark:bg-surface-950/50 rounded-xl p-6 border border-surface-300 dark:border-surface-800">
                <div className="text-4xl font-bold text-chrysolite-400 mb-2">95%</div>
                <p className="text-surface-600 dark:text-surface-400 text-sm">Customer Satisfaction Rate</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={industry}
                className="bg-surface-50/50 dark:bg-surface-900/50 border border-surface-300 dark:border-surface-800 rounded-xl p-4 text-center hover:border-chrysolite-500/30 transition-all"
              >
                <span className="text-surface-600 dark:text-surface-300">{industry}</span>
              </div>
            ))}
          </div>
        </div>
