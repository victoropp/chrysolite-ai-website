...
export default function PressPage() {
  return (
    <main className="bg-surface-950 min-h-screen">
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-700 rounded-2xl p-12 shadow-2xl">
            <h2 className="text-3xl font-bold text-white mb-6">About Chrysolite AI</h2>
            ...
            <div className="space-y-4 text-surface-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8 pt-8 border-t border-surface-700">
                <div>
                  <div className="text-3xl font-bold text-chrysolite-400 mb-2">2023</div>
                  <p className="text-surface-400 text-sm">Year Founded</p>
                </div>
                <div>
                  <div className="text-3xl font-bold text-chrysolite-400 mb-2">100+</div>
                  <p className="text-surface-400 text-sm">Active Customers</p>
                </div>
                <div>
                  <div className="text-3xl font-bold text-chrysolite-400 mb-2">10+</div>
                  <p className="text-surface-400 text-sm">Integrated Modules</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {pressResources.map((resource) => (
              <div
                key={resource.title}
                className="bg-surface-900/50 backdrop-blur-sm border border-surface-800 rounded-2xl p-8 hover:border-chrysolite-500/30 transition-all group"
              >
                ...
                <p className="text-surface-400 mb-6">{resource.description}</p>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-surface-900 to-surface-800 border border-surface-700 rounded-2xl p-12 text-center shadow-2xl">
            ...
            <div className="space-y-4 text-surface-300">
              <div>
                <p className="font-semibold text-white">Media Contact</p>
