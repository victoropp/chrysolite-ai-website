      ...
      <section className="relative pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-surface-50/50 dark:bg-surface-900/50 border border-surface-300 dark:border-surface-800 rounded-2xl p-8 md:p-12 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Definitions</h2>
              <div className="space-y-4 text-surface-600 dark:text-surface-300 leading-relaxed">
                <p>
                  <strong className="text-surface-900 dark:text-white">"Personal Data"</strong> means any information relating
                  to an identified or identifiable natural person that is processed by Chrysolite AI as
                  part of providing the Services.
                </p>
                <p>
                  <strong className="text-surface-900 dark:text-white">"Processing"</strong> means any operation performed on
                  Personal Data, including collection, storage, use, disclosure, or deletion.
                </p>
                <p>
                  <strong className="text-surface-900 dark:text-white">"Data Controller"</strong> refers to the Customer, who
                  determines the purposes and means of processing Personal Data.
                </p>
                <p>
                  <strong className="text-surface-900 dark:text-white">"Data Processor"</strong> refers to Chrysolite AI, who
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Data Processing</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-2">1. Scope and Purpose</h3>
                  <p className="text-surface-600 dark:text-surface-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-2">2. Duration</h3>
                  <p className="text-surface-600 dark:text-surface-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-2">3. Categories of Data</h3>
                  <p className="text-surface-600 dark:text-surface-300 leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Sub-Processors</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Data Subject Rights</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Data Breach Notification</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Data Retention and Deletion</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">International Data Transfers</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-4">Audit Rights</h2>
              <p className="text-surface-600 dark:text-surface-300 leading-relaxed">
